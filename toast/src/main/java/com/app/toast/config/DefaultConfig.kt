 ...
 * 默认配置
 */
class DefaultConfig : ToastConfig {
    ...
    override fun toastBackgroundColor(type: Int): Int {
        ...
        return when (type) {
            ToastType.TYPE_INFO -> R.color.toast_background_color_default_info
            ToastType.TYPE_ERROR -> R.color.toast_background_color_default_error
            ToastType.TYPE_WARN -> R.color.toast_background_color_default_warn
            ToastType.TYPE_SUCCEED -> R.color.toast_background_color_default_succeed
            else -> R.color.toast_background_color_default_info
        }
    }
