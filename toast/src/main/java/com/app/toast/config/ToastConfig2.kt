 ...
 * 配置1
 */
class ToastConfig2 : ToastConfig {
    ...
    override fun toastBackgroundColor(type: Int): Int {
        ...
        return when (type) {
            ToastType.TYPE_INFO -> R.color.toast_background_color_config2_info
            ToastType.TYPE_ERROR -> R.color.toast_background_color_config2_error
            ToastType.TYPE_WARN -> R.color.toast_background_color_config2_warn
            ToastType.TYPE_SUCCEED -> R.color.toast_background_color_config2_succeed
            else -> R.color.toast_background_color_config2_info
        }
    }
