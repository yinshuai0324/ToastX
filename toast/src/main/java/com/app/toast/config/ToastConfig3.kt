 ...
 * 配置1
 */
class ToastConfig3 : ToastConfig {
    ...
    override fun toastBackgroundColor(type: Int): Int {
        ...
        return when (type) {
            ToastType.TYPE_INFO -> R.color.toast_background_color_config3_info
            ToastType.TYPE_ERROR -> R.color.toast_background_color_config3_error
            ToastType.TYPE_WARN -> R.color.toast_background_color_config3_warn
            ToastType.TYPE_SUCCEED -> R.color.toast_background_color_config3_succeed
            else -> R.color.toast_background_color_config3_info
        }
    }
